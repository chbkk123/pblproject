...
import nicarng.selcar.MainActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RegisterTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent RegisterIntent = new Intent(poplogin.this, RegisterActivity.class);
                poplogin.this.startActivity(RegisterIntent);
            }
        });
                    ...
                    public void onResponse(String response){
                        try{
                            ...
                            if(success){
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(poplogin.this);
