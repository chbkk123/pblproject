        ...
        switch (item.type) {
            case HEADER:
                ...
                if (item.invisibleChildren == null) {
                    itemController.btn_expand_toggle.setImageResource(android.R.drawable.arrow_up_float);
                } else {
                    itemController.btn_expand_toggle.setImageResource(android.R.drawable.arrow_down_float);
                }
